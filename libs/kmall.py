...
class kmall():
    ...
    def read_EMdgmScommon(self):
        ...
        '''
                ...
                12      0 = correctedLat_deg
                13      0 = correctedLon_deg
                14      0 = speedOverGround_mPerSec
                15      0 = courseOverGround_deg
        '''
    ...
    def listofdicts2dictoflists(self, listofdicts):
        ...
        if listofdicts:
            ...
            try:
                ...
                print(f"Warning: pandas DataFrame conversion failed: {e}")
                print("Falling back to manual dictionary conversion...")
                d_of_l = {}
                for k in listofdicts[0].keys():
                    d_of_l[k] = []
                    for dic in listofdicts:
                        if k in dic:
                            d_of_l[k].append(dic[k])
                        else:
                            d_of_l[k].append(None)
